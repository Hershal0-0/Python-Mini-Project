...
data = questions_data[:]
'''
	This function returns a dictionary from the above question data.
	It pops off the selected question so as to avoid repetition.
	If list becomes empty it reloads the complete list
'''
def getQuestion():
	global data
